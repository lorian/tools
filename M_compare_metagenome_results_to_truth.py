...
def process_input(filename,size,fragmented=False):
	...
	if fragmented:
		...
		print "Handling duplicates as separate chromosomes"
...
def calc_error(truth,est):
	...
	if true_species != est_species:
		if len(true_species) == len(est_species): # name synonyms
			...
			print "Mapped against larger or smaller sample of species than in dataset."
