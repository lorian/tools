...
def dataset_truth(dataset):
	...
	if dataset == 'i100':
		...
		truth.set_by_array([("Aeromonas hydrophila SSU",.1,0,1),("Bacillus cereus VD118",.1,0,1),("Bacteroides fragilis HMW615",.1,0,1),("Mycobacterium abscessus 6G-0125-R",.1,0,1),("Pelosinus fermentans A11",.1,0,1),("Rhodobacter sphaeroides 2.4.1",.1,0,1),("Staphylococcus aureus M0927",.1,0,1),("Streptococcus pneumoniae TIGR4",.1,0,1),("Vibrio cholerae CP1032(5)",.1,0,1),("Xanthomonas axonopodis pv. Manihotis UA323",.1,0,1)])
	elif dataset == 'miseq':
		truth.set_by_array([("Bacillus cereus VD118",.1,0,1),("Citrobacter freundii 47N",.1,0,1),("Enterobacter cloacae",.1,0,1),("Klebsiella pneumoniae NES14",.1,0,1),("Mycobacterium abscessus 6G-0125-R",.1,0,1),("Proteus vulgaris 66N",.1,0,1),("Rhodobacter sphaeroides 2.4.1",.1,0,1),("Staphylococcus aureus ST22",.1,0,1),("Salmonella enterica Montevideo str. N19965",.1,0,1),("Vibrio cholerae CP1032(5)])
	elif dataset == 'simHC20':
		truth.set_by_array([("Alkaliphilus metalliredigens QYMF",.05,500,1),("Bradyrhizobium sp. BTAi1",.05,500,1),("Burkholderia cepacia AMMD",.05,500,1),("Chelativorans sp. BNC1",.05,500,1),("Clostridium thermocellum ATCC 27405",.05,500,1),("Dechloromonas aromatica RCB",.05,500,1),("Desulfitobacterium hafniense DCB-2",.05,500,1),("Frankia sp. CcI3",.05,500,1),("Geobacter metallireducens GS-15",.05,500,1),("Marinobacter aquaeolei VT8",.05,500,1),("Methanosarcina barkeri Fusaro, DSM 804",.05,500,1),("Nitrobacter hamburgensis X14",.05,500,1),("Nocardioides sp. JS614",.05,500,1),("Polaromonas sp. JS666",.05,500,1),("Pseudoalteromonas atlantica T6c",.05,500,1),("Pseudomonas fluorescens Pf0-1",.05,500,1),("Rhodobacter sphaeroides 2.4.1, ATCC BAA-808",.05,500,1),("Shewanella sp. MR 7",.05,500,1),("Syntrophobacter fumaroxidans MPOB",.05,500,1)])
	else:
